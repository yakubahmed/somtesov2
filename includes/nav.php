...
<div class="navbar navbar-expand flex-column flex-md-row navbar-custom bg-info">
                <div class="container-fluid">
                    <!-- LOGO -->
                    <a href="index" class="navbar-brand mr-0 mr-md-2 logo">
                        <span class="logo-lg">
                            <img src="assets/images/somteso.png" alt="" height="24" />
                            <span class="d-inline h5 ml-1 text-logo">SOMTESO</span>
                        </span>
                        <span class="logo-sm">
                        ...
                        <li class="dropdown notification-list align-self-center profile-dropdown">
                            <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="#" role="button"
                                ...
                                <div class="media user-profile ">
                                    <img src="assets/images/<?php echo $_SESSION['img'];?>" alt="user-image" class="rounded-circle align-self-center" />
                                    <div class="media-body text-left">
                                        <h6 class="pro-user-name ml-2 my-0">
                                            <span><?php echo $_SESSION['fname'];?></span>
                                            <span class="pro-user-desc text-muted d-block mt-1"> </span>
                                        </h6>
                                    </div>
