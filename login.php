...
<?php if(isset($_SESSION['member_id'])){ header('location: index'); } ?>
<!DOCTYPE html>
<html lang="en">
    
<head>
        <meta charset="utf-8" />
        <title>SOMTESO Office - Login</title>
                                    ...
                                    <div class="col-md-6 p-5">
                                        <div class="mx-auto mb-5">
                                            <a href="index">
                                                ...
                                                <h3 class="d-inline align-middle ml-1 text-logo">SOMtESO <small>Office </small> </h3>
                                           ...
                                           <?php  disp_msg();?>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" id="username" placeholder="Enter your username" autocomplete="Off" autofocus name='username'>
                                                </div>
                                            </div>
